...
export default function UzbekistanTours() {
  ...
  useEffect(() => {
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        // keep only items that have 'Uzbekistan' (defensive)
        setTours(
          normalized.filter((t) =>
  ...
  // UPCOMING: closest 3 tours by startDate (prefer future; fallback to nearest past)
  ...
  // === RIGHT SIDE: categories (includes city tours) ===
  const categories = {
    Cultural: [],
    Gastronomy: [],
    Religious: [],
  ...
  // ensure unique items in each category (optional duplicates across categories ok)
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            {/* TOP 10 by seats (separate section, may repeat) */}
          ...
          {/* RIGHT - sidebar with collapsible categories */}
          <aside className={styles.sidebar}>
            <h3>Uzbekistan Tours</h3>
