...
import mainImg from "../../../assets/Countries/armenia.jpg"; // 🔁 replace with your actual Armenia image
...
export default function ArmeniaTours() {
  ...
  const normalizeTour = (rawItem) => {
    ...
    return {
      ...
      availableSeats: raw.availableSeats ?? raw.available ?? 0,
  ...
  const toursWithoutCity = tours.filter(
    (t) => !(t.tour_type || "").toLowerCase().includes("city")
  );
  ...
  tours.forEach((t) => {
    const ttype = (t.tour_type || "").toLowerCase();
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Armenia Tours</h2>
            ...
            <p className={styles.description}>
              Discover Armenia — a land of ancient monasteries, mountain
              landscapes, and warm hospitality. Explore Yerevan’s lively
              atmosphere, visit Garni and Geghard monasteries, and enjoy the
              breathtaking views of Mount Ararat.
            </p>
          </div>

          <aside className={styles.sidebar}>
            <h3>Armenia Group Tours</h3>
