      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Tajikistan Tours</h2>
            ...
            <p className={styles.description}>
              Explore Tajikistan’s rugged mountains, alpine lakes, and ancient
              Silk Road history. Journey along the Pamir Highway, trek through
              the stunning Fann Mountains, and experience warm Tajik
              hospitality.
            </p>
          </div>
