...
export default function KazakhstanTours() {
  ...
  // ✅ Fetch only Kazakhstan + Group tours
  useEffect(() => {
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Kazakhstan Tours</h2>
            ...
            <p className={styles.description}>
              Explore Kazakhstan’s diverse landscapes — from the futuristic
              cities of Astana and Almaty to the serene steppes, canyons, and
              mountain lakes. Experience the fusion of modern life and nomadic
              tradition in Central Asia’s largest country.
            </p>
          </div>

          {/* RIGHT */}
          <aside className={styles.sidebar}>
            <h3>Kazakhstan Group Tours</h3>
