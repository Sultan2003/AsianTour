      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Caucasus Tours</h2>
            ...
            <p className={styles.description}>
              Explore the Caucasus — a region where Europe meets Asia. Wander
              through Georgia’s charming towns, marvel at Armenia’s monasteries,
              and experience Azerbaijan’s fusion of history and modern energy.
            </p>
          </div>

          <aside className={styles.sidebar}>
            <h3>Caucasus Group Tours</h3>
