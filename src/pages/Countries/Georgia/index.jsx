...
export default function GeorgiaTours() {
  ...
  // fetch Georgia tours (only Group tours)
  useEffect(() => {
  ...
  tours.forEach((t) => {
    ...
    if (
      ...
      ttype.includes("church") ||
      ttype.includes("monastery")
    )
      pushIf("Religious");
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Georgia Tours</h2>
            ...
            <p className={styles.description}>
              Explore Georgia — the land of wine, mountains, and hospitality.
              Wander through Tbilisi’s old town, discover ancient monasteries in
              Mtskheta and climb up to Gergeti Trinity Church in the Caucasus
              mountains. Experience the charm of Georgian cuisine and the warmth
              of its people.
            </p>
          </div>
