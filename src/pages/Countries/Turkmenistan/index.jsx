...
export default function TurkmenistanTours() {
  ...
  useEffect(() => {
    const url = strapiLocale
      ? `${STRAPI_BASE}/api/asian-tours?locale=${strapiLocale}&filters[location][$eq]=Turkmenistan`
      : `${STRAPI_BASE}/api/asian-tours?filters[location][$eq]=Turkmenistan`;
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        setTours(
          normalized.filter(
            (t) =>
              (t.location || "").toLowerCase().includes("turkmenistan") &&
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Turkmenistan Tours</h2>
            ...
            <p className={styles.description}>
              Explore Turkmenistan, a land of ancient Silk Road cities,
              mesmerizing deserts, and marble-white capitals. Witness the
              blazing Darvaza Gas Crater, the majestic ruins of Merv, and
              Ashgabat’s dazzling modern architecture. Turkmenistan invites you
              to experience its mystery, culture, and timeless beauty.
            </p>
          </div>

          <aside className={styles.sidebar}>
            <h3>Turkmenistan Group Tours</h3>
