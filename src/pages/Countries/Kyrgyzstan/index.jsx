      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Kyrgyzstan Tours</h2>
            ...
            <p className={styles.description}>
              Discover Kyrgyzstan, a land of majestic mountains and rich nomadic
              traditions. From the turquoise waters of Issyk-Kul Lake to the
              dramatic Ala-Archa Gorge, Kyrgyzstan offers unforgettable
              adventures for those seeking both culture and nature.
            </p>
          </div>

          <aside className={styles.sidebar}>
            <h3>Kyrgyzstan Group Tours</h3>
