...
export default function SilkRoadPrivateTours() {
  ...
  // fetch tours (Silk Road, only Private tours)
  useEffect(() => {
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Silk Road Private Tours</h2>
            ...
            <p className={styles.description}>
              Discover the legendary Silk Road privately — travel through
              ancient trade routes, explore historic cities, and experience
              centuries of culture, architecture, and adventure at your own
              pace.
            </p>
          </div>
