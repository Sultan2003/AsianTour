...
export default function KazakhstanPrivateTours() {
  ...
  const normalizeTour = (rawItem) => {
    const raw = rawItem.attributes ? rawItem.attributes : raw;
  ...
  // ✅ Fetch Kazakhstan Private Tours
  useEffect(() => {
    const url = strapiLocale
      ? `${STRAPI_BASE}/api/asian-tours?locale=${strapiLocale}&filters[location][$eq]=Kazakhstan`
      : `${STRAPI_BASE}/api/asian-tours?filters[location][$eq]=Kazakhstan`;
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        setTours(
          normalized.filter(
            (t) =>
              (t.location || "").toLowerCase().includes("kazakhstan") &&
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Kazakhstan Private Tours</h2>
            ...
            <p className={styles.description}>
              Discover Kazakhstan privately with tailor-made itineraries across
              the vast steppes, modern cities, and ancient Silk Road towns.
            </p>
          </div>

          {/* RIGHT */}
          <aside className={styles.sidebar}>
            <h3>Kazakhstan Private Tours</h3>
