      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Azerbaijan Private Tours</h2>
            ...
            <p className={styles.description}>
              Explore Azerbaijan privately — from the modern skyline of Baku to
              the mountain villages of Quba. Discover ancient Silk Road
              heritage, Caspian Sea charm, and warm Azerbaijani hospitality
              through tailor-made tours.
            </p>
          </div>

          <aside className={styles.sidebar}>
            <h3>Azerbaijan Private Tours</h3>
