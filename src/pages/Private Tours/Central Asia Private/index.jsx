...
import styles from "./CentralAsiaPrivate.module.scss";
import mainImg from "../../../assets/Countries/centralasia.webp"; // 🖼️ Replace with your Central Asia image

const STRAPI_BASE = "https://brilliant-passion-7d3870e44b.strapiapp.com";

export default function CentralAsiaPrivateTours() {
  ...
  // fetch tours (Central Asia, only Private tours)
  useEffect(() => {
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        setTours(
          normalized.filter(
            (t) =>
              (t.location || "").toLowerCase().includes("central") &&
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Central Asia Private Tours</h2>
            ...
            <p className={styles.description}>
              Experience the beauty and diversity of Central Asia with private,
              customizable tours. Journey through the vast steppes of
              Kazakhstan, the mountains of Kyrgyzstan and Tajikistan, and the
              ancient cities of Uzbekistan and Turkmenistan — all tailored to
              your pace and preferences for a truly personal travel experience.
            </p>
          </div>

          {/* RIGHT */}
          <aside className={styles.sidebar}>
            <h3>Central Asia Private Tours</h3>
