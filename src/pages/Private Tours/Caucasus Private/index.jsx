...
export default function CaucasusPrivateTours() {
  ...
  // fetch tours (Caucasus, only Private tours)
  useEffect(() => {
    const url = strapiLocale
      ? `${STRAPI_BASE}/api/asian-tours?locale=${strapiLocale}&filters[location][$eq]=Caucasus`
      : `${STRAPI_BASE}/api/asian-tours?filters[location][$eq]=Caucasus`;
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        setTours(
          normalized.filter(
            (t) =>
              (t.location || "").toLowerCase().includes("caucasus") &&
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Caucasus Private Tours</h2>
            ...
            <p className={styles.description}>
              Explore the Caucasus privately — where Europe meets Asia. Discover
              Georgia’s mountain villages, Armenia’s ancient monasteries, and
              Azerbaijan’s Caspian beauty with a tailor-made experience.
            </p>
          </div>

          {/* RIGHT */}
          <aside className={styles.sidebar}>
            <h3>Caucasus Private Tours</h3>
