...
export default function TurkmenistanPrivateTours() {
  ...
  // fetch tours (Turkmenistan, only Private tours)
  useEffect(() => {
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Turkmenistan Private Tours</h2>
            ...
            <p className={styles.description}>
              Experience Turkmenistan privately with customized itineraries and
              explore its white-marble capital, desert wonders, and ancient
          ...
          <aside className={styles.sidebar}>
            <h3>Turkmenistan Private Tours</h3>
