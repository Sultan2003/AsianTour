...
export default function KyrgyzstanPrivateTours() {
  ...
  // fetch tours (Kyrgyzstan, only Private tours)
  useEffect(() => {
    const url = strapiLocale
      ? `${STRAPI_BASE}/api/asian-tours?locale=${strapiLocale}&filters[location][$eq]=Kyrgyzstan`
      : `${STRAPI_BASE}/api/asian-tours?filters[location][$eq]=Kyrgyzstan`;
    ...
    fetch(url)
      ...
      .then((data) => {
        ...
        setTours(
          normalized.filter(
            (t) =>
              (t.location || "").toLowerCase().includes("kyrgyzstan") &&
      ...
      <div className={styles.container}>
        <div className={styles.content}>
          ...
          <div className={styles.tours}>
            ...
            <h2 className={styles.sectionTitle}>Kyrgyzstan Private Tours</h2>
            ...
            <p className={styles.description}>
              Discover the beauty of Kyrgyzstan through private tours tailored
              to your interests. Journey across breathtaking mountain passes,
              alpine lakes, and traditional nomadic villages while enjoying
              complete comfort and personal attention.
            </p>
          </div>

          {/* RIGHT */}
          <aside className={styles.sidebar}>
            <h3>Kyrgyzstan Private Tours</h3>
